...
if (import.meta.main) {
  if (
    link == null || Deno.args.includes("--help") || Deno.args.includes("-h")
  ) {
    ...
    console.log(
      "<recipe_url>: URL of the recipe from Mob Kitchen to scrape (required)",
    );
    console.log(
      "[headless]: Whether to run the browser in headless mode (default: true)",
    );
    console.log(
      "Example: deno task run https://www.mob.co.uk/recipes/pizza true",
    );
    Deno.exit(0);
  }
